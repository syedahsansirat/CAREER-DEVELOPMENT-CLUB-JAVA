...
public class upcon implements ActionListener, MenuListener {
    ...
    JMenuBar menuBar;
    JMenu m1;
    JTextField t1, t2, t3, t4, tt, t6, t7, t8, t9, t10, t11, date, month, year;
    JLabel j1, j2, j3, j4, j5, jt, j6, j7, j8, j9, j10, j11, j12;
    ...
    upcon() {
        ...
        jfm.setLayout(new GridLayout(7, 2));

        j1 = new JLabel();
        j1.setText("Competition Number :");
        t1 = new JTextField();
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            ...
            String all = "INSERT into contest (contestNo,id,contestTitle,attandance,performance,cdate) values(" + s1 + "," + s2 + ",'" + st + "'," + s3 + "," + s4 + ",to_date('" + yyyy + mm + dd + "','YYYYMMDD'))";
