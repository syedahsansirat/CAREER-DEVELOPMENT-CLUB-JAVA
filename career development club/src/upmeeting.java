...
public class upmeeting implements ActionListener, MenuListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            ...
            String all = "INSERT into meeting (meetingNo,id,attandance,mdate) values(" + s1 + "," + s2 + "," + s3 + ",to_date('" + yyyy + mm + dd + "','YYYYMMDD'))";
